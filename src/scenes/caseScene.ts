...
export class caseScene extends Scene {
    ...
    onInitialize(engine: Engine<any>): void {
        ...
        let EscudoTimao = Resources.LogoTIMAO.toSprite()
        let EscudoPalmeiras = Resources.LogoPALMEIRAS.toSprite()
        let EscudoSaoPaulo = Resources.LogoSAOPAULO.toSprite()

        this.listaImagens = [EscudoTimao, EscudoPalmeiras, EscudoSaoPaulo]    
    }
